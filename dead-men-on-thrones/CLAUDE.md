...
**27 of 64 chapters drafted — all of Part One: The Documents (1–8), Part Two: The Councils (9–13), and Part Three: The Institution (14–22) are complete, and Part Four: The Violence is now complete with Chapters 23–27** (Chapters 1–8: Before the Book, The Man Who Forced the Question, The Lost Document, Four Accounts One Story, The Cosmic Gospel, The Man Who Built the Theology, The Brilliant Heretic, Closing the Book; Chapters 9–13: The Emperor's Church, One Letter's Difference, Making It Mandatory, The Creed as Weapon, The Ghost in the Machine; Chapters 14–22: Into the Vacuum, The Monk Who Made the Papacy, The Prophet and the Power, The Crown and the Keys, Barefoot in the Snow, The Dead Man on the Throne, The Pornocracy, The Babylonian Captivity, The Great Divorce; Chapters 23–27: God Wills It, Kill Them All, The Bankers and the Bonfire, The Inquisitor's Tools, The Night of St. Bartholomew). Each chapter has been fact-checked against outside sources before publishing and is live in `chapters/ch01.md` through `chapters/ch27.md`, wired into `chapter.html` and marked "Read" in `index.html`. Each chapter's sources are also documented in `DMOT_Notes_and_Sources.txt`/`sources.html` (Primary Sources / Modern Scholarship / Where This Is Contested, no inline footnotes per this book's own style rule) and key terms in `DMOT_Index.txt`/`book-index.html`. Chapters 25–27 are drafted under the no-em-dash rule (effective 2026-09-05) and all three have a narration script in `dead-men-on-thrones/audio/` (Chapters 1–24 don't have one; that's separate future cleanup work, not retroactive). Chapter 27 deliberately skipped a Marcion callback (Part Four already has substantive Marcion content in Chapters 23–24, and the Huguenots have no honest theological connection to him) and presented both Catherine de Medici's/Charles IX's actual culpability and the national death toll as genuinely contested among historians rather than settling on the more dramatic version; it also declined to repeat the popular legend of Charles IX firing on Huguenots from a Louvre balcony, which has no credible basis. Next up: Chapter 28, "The Man Who Died So Luther Could Live" (Jan Hus), the first chapter of Part Five: The Reformation.
