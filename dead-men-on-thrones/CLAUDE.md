...
**26 of 64 chapters drafted — all of Part One: The Documents (1–8), Part Two: The Councils (9–13), and Part Three: The Institution (14–22) are complete, and Part Four: The Violence is underway with Chapters 23–26** (Chapters 1–8: Before the Book, The Man Who Forced the Question, The Lost Document, Four Accounts One Story, The Cosmic Gospel, The Man Who Built the Theology, The Brilliant Heretic, Closing the Book; Chapters 9–13: The Emperor's Church, One Letter's Difference, Making It Mandatory, The Creed as Weapon, The Ghost in the Machine; Chapters 14–22: Into the Vacuum, The Monk Who Made the Papacy, The Prophet and the Power, The Crown and the Keys, Barefoot in the Snow, The Dead Man on the Throne, The Pornocracy, The Babylonian Captivity, The Great Divorce; Chapters 23–26: God Wills It, Kill Them All, The Bankers and the Bonfire, The Inquisitor's Tools). Each chapter has been fact-checked against outside sources before publishing and is live in `chapters/ch01.md` through `chapters/ch26.md`, wired into `chapter.html` and marked "Read" in `index.html`. Each chapter's sources are also documented in `DMOT_Notes_and_Sources.txt`/`sources.html` (Primary Sources / Modern Scholarship / Where This Is Contested, no inline footnotes per this book's own style rule) and key terms in `DMOT_Index.txt`/`book-index.html`. Chapters 25–26 are drafted under the no-em-dash rule (effective 2026-09-05) and both have a narration script in `dead-men-on-thrones/audio/` (Chapters 1–24 don't have one; that's separate future cleanup work, not retroactive). Chapter 26's outline claimed "160,000 Jews expelled" and "approximately two thousand burned at the stake under Torquemada"; fact-checking found the expulsion figure genuinely contested (Kamen's archival estimate: roughly 40,000-50,000; older estimates run into the hundreds of thousands) and the Torquemada figure correctly attributed to the nineteenth century historian Graetz rather than to Kamen, whose own institutional total (3,000-5,000) covers the Inquisition's full 356-year existence, not Torquemada's 15 years alone; see the chapter's own text and its `DMOT_Notes_and_Sources.txt` entry. Next up: Chapter 27, "The Night of St. Bartholomew" (the 1572 Paris massacre), the last chapter of Part Four.
...
## REVISION TODO — CRAFT NOTES FROM THE CH. 9–17 READER'S REPORT

A cold read-through of Chapters 9–17 back to back (Parts Two and the first stretch of Part Three) surfaced one dominant pattern plus a handful of small factual/reference slips. Read this before drafting Chapter 18 or revising 9–17.

### Systemic fixes — apply going forward, retrofit into 9–17 opportunistically

- [ ] **The "[X] is worth [verb]-ing" caveat-signpost is back under new spelling.** The Ch. 1–6 report flagged "the honest version of this book owes its reader a caveat" as a repeated, announcing tic and asked for it to be folded into the narrative instead. It didn't go away — it just re-surfaced in a different costume. At least one instance appears in 7 of these 9 chapters: "the argument is worth walking through slowly" (Ch. 9), "the number is worth pausing on" (Ch. 10), "It is worth being precise about who that law was actually aimed at" and "is worth one specific example rather than a summary" (Ch. 11, twice in one chapter), "One major exception is worth naming precisely" (Ch. 13), "It's worth pausing on the England connection specifically" (Ch. 15), "the honest version of this chapter owes its reader the theology" and "It is worth naming, carefully" (Ch. 16, twice), "is worth following to its own quiet, ironic end" (Ch. 17). The content each time is exactly right — these are almost all the chapter's best precision-and-fairness beats. The problem is purely mechanical: the same "is worth X-ing" scaffolding announces the move instead of just making it. Fix going forward by dropping straight into the caveat/precision itself ("Tradition remembers 318 bishops. The real count was smaller and vaguer" instead of "the number is worth pausing on for what it reveals...").
- [ ] **A new closing-line tic has replaced the old one.** Ch. 1–6 over-used the withheld-name sting; that's genuinely fixed. In its place, 5 of these 9 chapters (11, 12, 13, 14, 16) now end on an explicit "that's what the next chapter picks up" hand-off sentence. It reads well once or twice but is a pattern in sequence exactly the way the old sting was. Ch. 9, 15, and 17 show the alternative — a reflective capstone image or statement that doesn't reference the next chapter at all ("He would not have recognized most of what came after him as anything he'd intended. That, too, is close to the whole point.") — and should be the more common model going forward, with explicit hand-offs used more sparingly.
- [ ] **A couple of exact phrases have now been used twice.** "Close to a thousand years" (Ch. 9, Constantinople's political longevity; Ch. 14, Roman material culture's disappearance) and "not incidentally" (Ch. 9; Ch. 13) are small enough to be invisible chapter-by-chapter but worth retiring or varying now that they've recurred once.
- [ ] **Cross-chapter citations need a final numeral check before publishing, every time.** Two actual errors were caught and fixed in this pass: Ch. 16 cited "this book's ninth and tenth chapters" for the Nicaea/Constantinople doctrine when the correct chapters are the tenth and eleventh (fixed); Ch. 13 stated "two hundred and eight years" from the 380 Edict of Thessalonica to the 589 Third Council of Toledo, which is actually two hundred and nine years (fixed). Also fixed: Ch. 16 broke the book's own "spelled-out ordinal" convention for chapter cross-references with a bare "Chapter 15 already showed..." (now "This book's previous chapter..."), and Ch. 13's "this book's own last two chapters" for the Theodosius edict/Council of Constantinople content, which is specifically the eleventh chapter's material, not the eleventh and twelfth combined (now reads "this book's own eleventh chapter"). None of these were caught by the per-chapter pre-publish checklist because each chapter was fact-checked in isolation — cross-references to other chapters need to be verified against those chapters' actual content, not just against memory of what they were "about."

### What's actually working and should be preserved

- **Dramatized openings are now consistently strong.** Every chapter in this batch opens on a concrete scene rather than a compressed summary — Ch. 6's problem from the earlier report hasn't recurred. No chapter here needs an opening rewrite.
- **Counter-narrative texture has genuinely improved, not just been patched once.** Empress Irene (Ch. 17) and Theodelinda (Ch. 13) both carry real narrative weight and agency rather than a token mention; this is a real change from the Ch. 2–6 pattern the earlier report flagged.
- **Prose rhythm is varying by subject more than the Ch. 1–6 batch did** — Ch. 12's more analytical, textual register for the Creed reads differently from Ch. 11's procedural legal register, which reads differently from Ch. 17's staged political drama. Keep doing this deliberately rather than letting it happen by accident.
- **Humor is landing where the material supports it and staying quiet where it shouldn't** — Ch. 14's "least dramatic ending available to a five-century institution," Ch. 17's Irene coda — without forcing a joke into genuinely grim chapters like Ch. 11's massacre-and-mandatory-law material. Good judgment; keep calibrating chapter by chapter rather than by quota.
