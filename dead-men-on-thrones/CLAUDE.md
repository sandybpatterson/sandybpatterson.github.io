...
**28 of 64 chapters drafted — all of Part One: The Documents (1–8), Part Two: The Councils (9–13), and Part Three: The Institution (14–22) are complete, Part Four: The Violence is complete with Chapters 23–27, and Part Five: The Reformation is underway with Chapter 28** (Chapters 1–8: Before the Book, The Man Who Forced the Question, The Lost Document, Four Accounts One Story, The Cosmic Gospel, The Man Who Built the Theology, The Brilliant Heretic, Closing the Book; Chapters 9–13: The Emperor's Church, One Letter's Difference, Making It Mandatory, The Creed as Weapon, The Ghost in the Machine; Chapters 14–22: Into the Vacuum, The Monk Who Made the Papacy, The Prophet and the Power, The Crown and the Keys, Barefoot in the Snow, The Dead Man on the Throne, The Pornocracy, The Babylonian Captivity, The Great Divorce; Chapters 23–27: God Wills It, Kill Them All, The Bankers and the Bonfire, The Inquisitor's Tools, The Night of St. Bartholomew; Chapter 28: The Man Who Died So Luther Could Live). Each chapter has been fact-checked against outside sources before publishing and is live in `chapters/ch01.md` through `chapters/ch28.md`, wired into `chapter.html` and marked "Read" in `index.html`. Each chapter's sources are also documented in `DMOT_Notes_and_Sources.txt`/`sources.html` (Primary Sources / Modern Scholarship / Where This Is Contested, no inline footnotes per this book's own style rule) and key terms in `DMOT_Index.txt`/`book-index.html`. Chapters 25–28 are drafted under the no-em-dash rule (effective 2026-09-05) and all four have a narration script in `dead-men-on-thrones/audio/` (Chapters 1–24 don't have one; that's separate future cleanup work, not retroactive). Chapter 28 corrected the popular but unverified "Yes, I am a Hussite" line staged as something Luther said on the floor at the 1519 Leipzig Debate (it doesn't appear in the actual disputation records), using instead his correctly sourced and dated February 14, 1520 letter to Georg Spalatin ("sumus omnes Hussitae ignorantes"); it also treats Hus's birth year as genuinely uncertain rather than asserting the legendary July 6 birthdate that was retrofitted to match his execution date, and it deliberately does not re-narrate the Western Schism/Council of Constance material already covered in Chapter 21, using a one-line callback instead. Next up: Chapter 29, "The Printing Press Changes Everything" (Gutenberg, and why Luther survived where Hus didn't).
